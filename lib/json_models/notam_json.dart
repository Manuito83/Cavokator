...
List<NotamJson> notamJsonFromJson(String str) {
  ...
  return List<NotamJson>.from(jsonData.map((x) => NotamJson.fromJson(x)));
}
...
class NotamJson {
  ...
  factory NotamJson.fromJson(Map<String, dynamic> json) => NotamJson(
        ...
        airportNotam: json["AirportNotam"] == null
            ? null
            : List<AirportNotam>.from(json["AirportNotam"].map((x) => AirportNotam.fromJson(x))),
        fullAirportDetails:
  ...
  Map<String, dynamic> toJson() => {
        ...
        "AirportNotam": airportNotam == null ? null : List<dynamic>.from(airportNotam!.map((x) => x.toJson())),
...
class AirportNotam {
  ...
  factory AirportNotam.fromJson(Map<String, dynamic> json) => AirportNotam(
