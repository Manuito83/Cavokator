...
List<WxJson> wxJsonFromJson(String str) {
  ...
  return new List<WxJson>.from(jsonData.map((x) => WxJson.fromJson(x)));
}
...
class WxJson {
  ...
  factory WxJson.fromJson(Map<String, dynamic> json) => new WxJson(
    ...
    metars: json["Metars"] == null ? null : new List<Metar>.from(json["Metars"].map((x) => Metar.fromJson(x))),
    tafors: json["Tafors"] == null ? null : new List<Tafor>.from(json["Tafors"].map((x) => Tafor.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "Metars": metars == null ? null : new List<dynamic>.from(metars.map((x) => x.toJson())),
    "Tafors": tafors == null ? null : new List<dynamic>.from(tafors.map((x) => x.toJson())),
...
class Metar {
  ...
  factory Metar.fromJson(Map<String, dynamic> json) => new Metar(
...
class Tafor {
  ...
  factory Tafor.fromJson(Map<String, dynamic> json) => new Tafor(
