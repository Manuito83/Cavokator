...
class _WeatherPageState extends State<WeatherPage> {
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        if (_formKey.currentState.validate()) {
                          ...
                          var lala = _getWeatherInformation();
                        }
  ...
  Future<http.Response> _getWeatherInformation() {
    var cuac = http.post(
        'https://manuito.a2hosted.com/CavokatorApi_V2/Wx/GetWx?source=Cavokator&airports=LEZL');
