...
class FavouritesBackupsPage extends StatefulWidget {
  ...
  FavouritesBackupsPage({required this.isThemeDark, this.currentFavList, this.updateCallback});
...
class _FavouritesBackupsPageState extends State<FavouritesBackupsPage> {
  ...
  List<Favourite>? _currentFavList = <Favourite>[];
  List<Favourite> _tentativeImportList = <Favourite>[];

  String _exportInfo = "In order to export & backup your favourites, you can either copy/paste "
      "to a text file manually, or share and save it at your desired location. "
      "In any case, please keep the text original structure.";

  String _importInfo = "In order to import favourites, please paste here the string that "
      "you exported in the past. You can make changes outside of Cavokator, "
      "but ensure that the main structure is kept!";

  String _importChoice = "you can either add them to your current list, or replace everything "
  ...
  void _exportShare() {
    ...
    String favouriteListToJson = encoder.convert((List<dynamic>.from(_currentFavList!.map((x) => x.toJson()))));
                      ...
                      children: <Widget>[
                          ...
                          onPressed: () {
                            ...
                            setState(() {
                              _importHintText = "Added ${_tentativeImportList.length} "
                                  " favourites to the existing list!";
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            setState(() {
                              _importHintText = "Created  list with "
                                  "${_tentativeImportList.length} favourites!";
                              _importHintStyle = Colors.green;
                              _importHintWeight = FontWeight.bold;
                            });
